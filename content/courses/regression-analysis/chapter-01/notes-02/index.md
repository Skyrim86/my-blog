...
date: 2026-09-15
draft: false
description: "§7–§8：回归系数的假设检验（构造逻辑、拒绝域、p 值与四种解读、与置信区间的等价性）、方差分析与 F 检验（平方和分解、期望均方、方差分析表）。"
# summary 必须写：列表卡片摘要走 `.Summary | plainify`，正文公式已渲染成 HTML+MathML，会被拼成乱码
summary: "§7–§8：回归系数的假设检验（构造逻辑、拒绝域、p 值与四种解读、与置信区间的等价性）、方差分析与 F 检验（平方和分解、期望均方、方差分析表）。"
---
